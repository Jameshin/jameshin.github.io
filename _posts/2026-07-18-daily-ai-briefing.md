...
## 💡 오늘의 기술 핵심 요약
❌ Gemini API 호출 실패: 403 PERMISSION_DENIED. {'error': {'code': 403, 'message': 'Your API key was reported as leaked. Please use another API key.', 'status': 'PERMISSION_DENIED'}}
