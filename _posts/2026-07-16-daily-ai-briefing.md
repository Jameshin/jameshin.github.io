...
## 💡 오늘의 기술 핵심 요약
❌ Gemini API 호출 실패: 404 NOT_FOUND. {'error': {'code': 404, 'message': 'models/gemini-2.5 is not found for API version v1beta, or is not supported for generateContent. Call ModelService.ListModels to see the list of available models and their supported methods.', 'status': 'NOT_FOUND'}}
